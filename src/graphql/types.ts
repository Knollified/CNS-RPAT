...
export type UpcomingEventsQuery = { events: (
...
export type AccountSettingsGetUserQuery = { user: Pick<Types.User, 'id' | 'name' | 'email' | 'avatarUrl' | 'jobTitle' | 'phone' | 'timezone'> };
...
export type AccountSettingsUpdateUserMutation = { updateOneUser: Pick<Types.User, 'id' | 'name' | 'email' | 'avatarUrl' | 'jobTitle' | 'phone' | 'timezone'> };
...
export type NotificationsQuery = { audits: (
...
export type NotificationsDealsQuery = { deals: { nodes: Array<(
...
export type EventCategoriesQuery = { eventCategories: (
...
export type CompaniesSelectQuery = { companies: { nodes: Array<Pick<Types.Company, 'id' | 'name' | 'avatarUrl'>> } };
...
export type ContactsSelectQuery = { contacts: { nodes: Array<Pick<Types.Contact, 'id' | 'name' | 'avatarUrl'>> } };
...
export type DealStagesSelectQuery = { dealStages: { nodes: Array<Pick<Types.DealStage, 'id' | 'title'>> } };
...
export type UsersSelectQuery = { users: { nodes: Array<Pick<Types.User, 'id' | 'name' | 'avatarUrl'>> } };
...
export type RefreshTokenMutation = { refreshToken: Pick<Types.AuthResponse, 'accessToken' | 'refreshToken'> };
...
export type AdministrationUsersQuery = { users: (
    Pick<Types.UserConnection, 'totalCount'>
    & { nodes: Array<Pick<Types.User, 'id' | 'name' | 'jobTitle' | 'role' | 'avatarUrl'>> }
  ) };
...
export type AdministrationAuditLogsQuery = { audits: (
    Pick<Types.AuditConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Audit, 'id' | 'action' | 'targetEntity' | 'targetId' | 'createdAt'>
      & { user?: Types.Maybe<Pick<Types.User, 'id' | 'name' | 'avatarUrl'>>, changes: Array<Pick<Types.AuditChange, 'field' | 'from' | 'to'>> }
    )> }
  ) };
...
export type CalendarEventsQuery = { events: (
    Pick<Types.EventConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Event, 'id' | 'title' | 'description' | 'startDate' | 'endDate' | 'color' | 'createdAt'>
      & { createdBy: Pick<Types.User, 'id' | 'name'>, category: Pick<Types.EventCategory, 'id' | 'title'> }
    )> }
  ) };
...
export type CreateEventCategoriesMutation = { createManyEventCategories: Array<Pick<Types.EventCategory, 'id' | 'title'>> };

export type EventFragmentFragment = (
  Pick<Types.Event, 'id' | 'title' | 'description' | 'startDate' | 'endDate' | 'color' | 'createdAt'>
  & { createdBy: Pick<Types.User, 'id' | 'name'>, category: Pick<Types.EventCategory, 'id' | 'title'>, participants: Array<Pick<Types.User, 'id' | 'name'>> }
);
...
export type UpdateEventMutation = { updateOneEvent: (
    Pick<Types.Event, 'id' | 'title' | 'description' | 'startDate' | 'endDate' | 'color' | 'createdAt'>
    & { createdBy: Pick<Types.User, 'id' | 'name'>, category: Pick<Types.EventCategory, 'id' | 'title'>, participants: Array<Pick<Types.User, 'id' | 'name'>> }
  ) };
...
export type CompanyContactsGetCompanyQuery = { company: (
...
export type CompanyDealsTableQuery = { deals: (
    Pick<Types.DealConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Deal, 'id' | 'title' | 'value'>
      & { stage?: Types.Maybe<Pick<Types.DealStage, 'id' | 'title'>>, dealOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'>, dealContact: Pick<Types.Contact, 'id' | 'name' | 'avatarUrl'> }
    )> }
  ) };
...
export type CompanyTotalDealsAmountQuery = { company: { dealsAggregate: Array<{ sum?: Types.Maybe<Pick<Types.CompanyDealsSumAggregate, 'value'>> }> } };
...
export type CompanyInfoQuery = { company: Pick<Types.Company, 'id' | 'totalRevenue' | 'industry' | 'companySize' | 'businessType' | 'country' | 'website'> };
...
export type CompanyCreateCompanyNoteMutation = { createOneCompanyNote: Pick<Types.CompanyNote, 'id' | 'note'> };

export type CompanyCompanyNotesQueryVariables = Types.Exact<{
  filter: Types.CompanyNoteFilter;
  sorting?: Types.InputMaybe<Array<Types.CompanyNoteSort> | Types.CompanyNoteSort>;
  paging: Types.OffsetPaging;
}>;


export type CompanyCompanyNotesQuery = { companyNotes: (
    Pick<Types.CompanyNoteConnection, 'totalCount'>
    & { nodes: Array<(
...
export type CompanyUpdateCompanyNoteMutation = { updateOneCompanyNote: Pick<Types.CompanyNote, 'id' | 'note'> };
...
export type CompanyQuotesTableQuery = { quotes: (
    Pick<Types.QuoteConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Quote, 'id' | 'title' | 'status' | 'total'>
      & { company: Pick<Types.Company, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'> }
    )> }
  ) };
...
export type CompanyTitleFormMutation = { updateOneCompany: (
...
export type CompanyTitleQuery = { company: (
    Pick<Types.Company, 'id' | 'name' | 'createdAt' | 'avatarUrl'>
    & { salesOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'> }
  ) };
...
export type CompaniesTableQuery = { companies: (
    Pick<Types.CompanyConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Company, 'id' | 'name' | 'avatarUrl'>
      & { dealsAggregate: Array<{ sum?: Types.Maybe<Pick<Types.CompanyDealsSumAggregate, 'value'>> }>, salesOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'>, contacts: { nodes: Array<Pick<Types.Contact, 'id' | 'name' | 'avatarUrl'>> } }
    )> }
  ) };
...
export type ContactsCreateContactNoteMutation = { createOneContactNote: Pick<Types.ContactNote, 'id' | 'note'> };
...
export type ContactsUpdateContactNoteMutation = { updateOneContactNote: Pick<Types.ContactNote, 'id' | 'note'> };

export type ContactsContactNotesListQueryVariables = Types.Exact<{
  filter: Types.ContactNoteFilter;
  sorting?: Types.InputMaybe<Array<Types.ContactNoteSort> | Types.ContactNoteSort>;
  paging: Types.OffsetPaging;
}>;


export type ContactsContactNotesListQuery = { contactNotes: (
    Pick<Types.ContactNoteConnection, 'totalCount'>
    & { nodes: Array<(
...
export type ContactsListQuery = { contacts: (
    Pick<Types.ContactConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Contact, 'id' | 'name' | 'email' | 'jobTitle' | 'status' | 'avatarUrl'>
...
export type ContactShowQuery = { contact: (
    Pick<Types.Contact, 'id' | 'name' | 'email' | 'status' | 'jobTitle' | 'phone' | 'timezone' | 'avatarUrl' | 'createdAt'>
    & { company: Pick<Types.Company, 'id' | 'name' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'> }
  ) };
...
export type LatestActivitiesDealsQuery = { deals: { nodes: Array<(
      Pick<Types.Deal, 'id' | 'title'>
      & { stage?: Types.Maybe<Pick<Types.DealStage, 'id' | 'title'>>, company: Pick<Types.Company, 'id' | 'name' | 'avatarUrl'> }
    )> } };
...
export type LatestActivitiesAuditsQuery = { audits: { nodes: Array<(
      Pick<Types.Audit, 'id' | 'action' | 'targetEntity' | 'targetId' | 'createdAt'>
...
export type DashboardDealsChartQuery = { dealStages: { nodes: Array<(
...
export type DashboardTasksChartQuery = { taskStages: { nodes: Array<(
      Pick<Types.TaskStage, 'title'>
      & { tasksAggregate: Array<{ count?: Types.Maybe<Pick<Types.TaskStageTasksCountAggregate, 'id'>> }> }
    )> } };
...
export type DashboardTotalRevenueQuery = { dealStages: { nodes: Array<(
      Pick<Types.DealStage, 'title'>
      & { dealsAggregate: Array<{ sum?: Types.Maybe<Pick<Types.DealStageDealsSumAggregate, 'value'>> }> }
    )> } };
...
export type QuoteFieldsFragment = (
  Pick<Types.Quote, 'id' | 'title' | 'status' | 'description' | 'subTotal' | 'total' | 'tax' | 'createdAt'>
  & { items: Array<Pick<Types.QuoteItem, 'title' | 'unitPrice' | 'quantity' | 'discount' | 'totalPrice'>>, company: Pick<Types.Company, 'id' | 'name' | 'country' | 'website' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name'> }
);
...
export type QuotesTableQuery = { quotes: (
    Pick<Types.QuoteConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Quote, 'id' | 'title' | 'status' | 'description' | 'subTotal' | 'total' | 'tax' | 'createdAt'>
      & { items: Array<Pick<Types.QuoteItem, 'title' | 'unitPrice' | 'quantity' | 'discount' | 'totalPrice'>>, company: Pick<Types.Company, 'id' | 'name' | 'country' | 'website' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name'> }
...
export type QuotesGetQuoteQuery = { quote: (
    Pick<Types.Quote, 'id' | 'title' | 'status' | 'description' | 'subTotal' | 'total' | 'tax' | 'createdAt'>
    & { items: Array<Pick<Types.QuoteItem, 'title' | 'unitPrice' | 'quantity' | 'discount' | 'totalPrice'>>, company: Pick<Types.Company, 'id' | 'name' | 'country' | 'website' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name'> }
  ) };
...
export type QuotesCreateQuoteMutation = { createOneQuote: (
    Pick<Types.Quote, 'id' | 'title' | 'status' | 'description' | 'subTotal' | 'total' | 'tax' | 'createdAt'>
    & { items: Array<Pick<Types.QuoteItem, 'title' | 'unitPrice' | 'quantity' | 'discount' | 'totalPrice'>>, company: Pick<Types.Company, 'id' | 'name' | 'country' | 'website' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name'> }
  ) };
...
export type QuotesUpdateQuoteMutation = { updateOneQuote: (
    Pick<Types.Quote, 'id' | 'title' | 'status' | 'description' | 'subTotal' | 'total' | 'tax' | 'createdAt'>
    & { items: Array<Pick<Types.QuoteItem, 'title' | 'unitPrice' | 'quantity' | 'discount' | 'totalPrice'>>, company: Pick<Types.Company, 'id' | 'name' | 'country' | 'website' | 'avatarUrl'>, salesOwner: Pick<Types.User, 'id' | 'name'>, contact: Pick<Types.Contact, 'id' | 'name'> }
  ) };
...
export type TaskStagesSelectQuery = { taskStages: { nodes: Array<Pick<Types.TaskStage, 'id' | 'title'>> } };
...
export type KanbanCreateStageMutation = { createOneTaskStage: Pick<Types.TaskStage, 'id' | 'title' | 'createdAt'> };
...
export type KanbanCreateTaskMutation = { createOneTask: Pick<Types.Task, 'id'> };
...
export type KanbanUpdateStageMutation = { updateOneTaskStage: Pick<Types.TaskStage, 'id' | 'title'> };
...
export type KanbanGetTaskQuery = { task: (
...
export type KanbanUpdateTaskMutation = { updateOneTask: (
    Pick<Types.Task, 'id' | 'title' | 'completed' | 'description' | 'dueDate'>
    & { stage?: Types.Maybe<Pick<Types.TaskStage, 'id' | 'title'>>, users: Array<Pick<Types.User, 'id' | 'name' | 'avatarUrl'>>, checklist: Array<Pick<Types.CheckListItem, 'title' | 'checked'>> }
  ) };
...
export type KanbanTaskCommentsQueryVariables = Types.Exact<{
  ...
  sorting?: Types.InputMaybe<Array<Types.TaskCommentSort> | Types.TaskCommentSort>;
  paging: Types.OffsetPaging;
}>;


export type KanbanTaskCommentsQuery = { taskComments: (
    Pick<Types.TaskCommentConnection, 'totalCount'>
    & { nodes: Array<(
...
export type KanbanTaskStagesQuery = { taskStages: (
...
export type KanbanTasksQuery = { tasks: (
    Pick<Types.TaskConnection, 'totalCount'>
    & { nodes: Array<(
      Pick<Types.Task, 'id' | 'title' | 'description' | 'dueDate' | 'completed' | 'stageId'>
      & { checklist: Array<Pick<Types.CheckListItem, 'title' | 'checked'>>, users: Array<Pick<Types.User, 'id' | 'name' | 'avatarUrl'>>, comments: Pick<Types.TaskCommentsConnection, 'totalCount'> }
    )> }
  ) };
...
export type SalesCompaniesSelectQuery = { companies: { nodes: Array<(
      Pick<Types.Company, 'id' | 'name' | 'avatarUrl'>
      & { contacts: { nodes: Array<Pick<Types.Contact, 'name' | 'id' | 'avatarUrl'>> } }
    )> } };
...
export type SalesCreateDealStageMutation = { createOneDealStage: Pick<Types.DealStage, 'id'> };
...
export type SalesCreateContactMutation = { createOneContact: Pick<Types.Contact, 'id'> };
...
export type SalesUpdateDealStageMutation = { updateOneDealStage: Pick<Types.DealStage, 'id' | 'title'> };
...
export type SalesUpdateDealMutation = { updateOneDeal: (
    Pick<Types.Deal, 'id' | 'title' | 'stageId' | 'value' | 'dealOwnerId'>
    & { company: (
...
export type SalesFinalizeDealMutation = { updateOneDeal: Pick<Types.Deal, 'id' | 'notes' | 'closeDateYear' | 'closeDateMonth' | 'closeDateDay'> };
...
export type SalesDealStagesQuery = { dealStages: (
...
export type SalesDealsQuery = { deals: { nodes: Array<(
      Pick<Types.Deal, 'id' | 'title' | 'value' | 'createdAt' | 'stageId'>
      & { company: Pick<Types.Company, 'id' | 'name' | 'avatarUrl'>, dealOwner: Pick<Types.User, 'id' | 'name' | 'avatarUrl'> }
    )> } };
